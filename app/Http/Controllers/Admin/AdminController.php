...
class AdminController extends Controller
{
    ...
    public function index()
    {
        $stats = [
            ...
            'active_content_sections' => ContentSection::where('is_active', true)->count(),
        ...
        $recent_content = ContentSection::orderBy('updated_at', 'desc')->limit(5)->get();

        return view('admin.dashboard', compact('stats', 'recent_news', 'recent_images', 'recent_content'));
    }
}
